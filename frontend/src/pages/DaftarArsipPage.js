...
function DaftarArsipPage() {
    ...
    // State untuk form sudah disederhanakan (tanpa nomor manual)
    ...
    const fetchArsipData = async () => {
        try {
            ...
            // Mengurutkan daftar kode klarifikasi
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            fetchArsipData(); // Muat ulang data
            setActiveTab('Rekap'); // Pindah ke tab rekap
        } catch (error) {
    ...
    const handleDownloadExcel = () => {
        // ... (Fungsi handleDownloadExcel tidak berubah)
    };
                ...
                <form onSubmit={handleSubmit}>
                    <fieldset>
                        ...
                        <div className="form-grid">
                            {/* Input nomorBerkas dan nomorItem sudah dihapus */}
